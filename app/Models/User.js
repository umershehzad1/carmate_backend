...
module.exports = (sequelize, DataTypes) => {
  class User extends Model {
    ...
    static associate(models) {
      User.hasOne(models.Repair, { // or hasMany if multiple repairs allowed
        foreignKey: 'userId',
        as: 'repair',
        onDelete: 'CASCADE',
      });
...
User.hasMany(models.RepairReferral, {
...
User.hasMany(models.Notifications, {
  ...
  User.init({
    ...
    role: {type: DataTypes.ENUM('user', 'admin', 'repair','insurance','dealer'), defaultValue: 'user'}
  }, {
    sequelize,
    modelName: 'User',
  });
